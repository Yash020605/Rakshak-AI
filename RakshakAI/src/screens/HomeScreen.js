...
const EMERGENCY_TYPES = [
  { type: 'medical', label: 'AMBULANCE', sub: 'Medical Emergency', emoji: '🚑', color: '#E53935', icon: '🏥' },
  { type: 'fire',    label: 'FIRE',      sub: 'Fire Emergency',    emoji: '🔥', color: '#F57C00', icon: '🔥' },
  { type: 'police',  label: 'POLICE',    sub: 'Police Assistance',  emoji: '🛡️', color: '#1565C0', icon: '🚔' },
];
